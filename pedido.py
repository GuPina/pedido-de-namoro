...
#insira a mensagem para exibir após a pessoa aceitar
def accepted():
...
# coloque aqui o pedido que você quer, seja namorar, casar e por ai vai
text_id = Label(root, bg='#ffc8dd', text='Quer namorar comigo?', fg='#590d22', font=('Montserrat', 24, 'bold'))
text_id.pack()


button_1 = tk.Button(root, text='Não', bg='#ffb3c1', command=denided, relief=RIDGE, bd=3, font=('Montserrat', 8, 'bold'))
button_1.pack()
